 ...
 * crypto.subtle is async and EInvoicingTransport.buildArtifact is sync by contract, so
 * the render-time statutory artifact needs a pure sync digest (no npm package). */
