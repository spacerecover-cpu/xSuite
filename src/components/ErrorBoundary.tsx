...
export class ErrorBoundary extends React.Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  render() {
    if (this.state.hasError) {
      ...
      return <ErrorFallbackScreen error={this.state.error} onRetry={this.handleReset} />;
    }
...
/**
 * Presentational crash/update screen, shared by the class ErrorBoundary and the
 * data router's errorElement (RouteErrorFallback).
 */
export function ErrorFallbackScreen({ error, onRetry }: { error: Error | null; onRetry: () => void }) {
